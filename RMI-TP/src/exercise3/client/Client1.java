...
public class Client1 {
	 //
	  ...
	  public static void main(String[] args) throws Exception {
	    ...
	    System.out.println("client sending (Washingtone, Pentagone)");
	   	repository.setProperty("Washington", "Pentagone");
	   	String s  = repository.getProperty("Washington");
	    ...
	    repository.removeProperty("Washington");
	    String s2 = repository.getProperty("Washington");
